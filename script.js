...
function playGame(input){
    ...
    let computerScore = document.querySelector('#computerScore').innerText;
    let playerScore = document.querySelector('#playerScore').innerText;
    let tie = document.querySelector('#ties').innerText;
    let result = '';

    let computerSelection = computerPlay();
    let playerSelection = playerPlay(input);
    ...
    if (result == "winner") {
        ...
        tie++;
        document.querySelector('#ties').innerText = tie;
    }
    
    // Logic to declare winner of all 5 games and display winner
    if (playerScore >= 5 ){
        document.querySelector('#bestOfFive').innerText = `You win! You beat the computer ${playerScore} times!`
    }
    else if (computerScore >= 5){
        document.querySelector('#bestOfFive').innerText = `You lose! The computer beat you ${computerScore} times!`
    }
}
